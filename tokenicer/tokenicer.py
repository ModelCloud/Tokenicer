...
class Tokenicer():
    ...
    def auto_fix_model_config(self, model_config):
        if model_config.bos_token_id is None and hasattr(self.tokenizer, "bos_token_id") and self.tokenizer.bos_token_id is not None:
            model_config.bos_token = self.tokenizer.bos_token
            model_config.bos_token_id = self.tokenizer.bos_token_id

        if model_config.eos_token_id is None and hasattr(self.tokenizer, "eos_token_id") and self.tokenizer.eos_token_id is not None:
